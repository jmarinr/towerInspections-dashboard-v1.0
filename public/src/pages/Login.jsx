...
function TelecomAnimation() {
  return (
    <div style={{ position:'absolute',inset:0,overflow:'hidden',pointerEvents:'none',opacity:.18 }}>
      <svg width="100%" height="100%" viewBox="0 0 480 520" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
        <defs><style>{`
          @keyframes pulse-ring{0%{r:4;opacity:.9}100%{r:48;opacity:0}}
          @keyframes pulse-ring2{0%{r:4;opacity:.9}100%{r:72;opacity:0}}
          @keyframes data-flow{0%{stroke-dashoffset:200;opacity:0}10%{opacity:1}90%{opacity:1}100%{stroke-dashoffset:0;opacity:0}}
          @keyframes node-blink{0%,100%{opacity:.6}50%{opacity:1}}
          @keyframes tower-glow{0%,100%{filter:drop-shadow(0 0 2px #0284C7)}50%{filter:drop-shadow(0 0 8px #0284C7)}}
          @keyframes signal-arc{0%{stroke-dashoffset:60;opacity:0}15%{opacity:.8}85%{opacity:.8}100%{stroke-dashoffset:0;opacity:0}}
          ...
          .line3{stroke-dasharray:200;animation:data-flow 3.8s linear infinite .6s}
        ...
        <g className="twr" transform="translate(90,280)">
          ...
          <line x1="-16" y1="75" x2="16" y2="55" stroke="#0284C7" strokeWidth=".8" opacity=".6"/>
          <line x1="16" y1="75" x2="-16" y2="55" stroke="#0284C7" strokeWidth=".8" opacity=".6"/>
          <line x1="-10" y1="50" x2="10" y2="30" stroke="#0284C7" strokeWidth=".8" opacity=".6"/>
          <line x1="10" y1="50" x2="-10" y2="30" stroke="#0284C7" strokeWidth=".8" opacity=".6"/>
        ...
        <circle className="t1-pulse" cx="90" cy="252" fill="none" stroke="#0284C7" strokeWidth=".8"/>
        <circle className="t1-pulse2" cx="90" cy="252" fill="none" stroke="#0284C7" strokeWidth=".8"/>
        <path className="arc1" d="M 68 238 A 26 26 0 0 1 112 238" fill="none" stroke="#0284C7" strokeWidth="1.2" strokeLinecap="round"/>
        <path className="arc2" d="M 56 226 A 40 40 0 0 1 124 226" fill="none" stroke="#0284C7" strokeWidth=".9" strokeLinecap="round"/>
        <g className="twr" transform="translate(360,180)">
          ...
          <line x1="-20" y1="100" x2="20" y2="75" stroke="#0284C7" strokeWidth=".8" opacity=".6"/>
          <line x1="20" y1="100" x2="-20" y2="75" stroke="#0284C7" strokeWidth=".8" opacity=".6"/>
          <line x1="-14" y1="70" x2="14" y2="48" stroke="#0284C7" strokeWidth=".8" opacity=".6"/>
          <line x1="14" y1="70" x2="-14" y2="48" stroke="#0284C7" strokeWidth=".8" opacity=".6"/>
          <line x1="-8" y1="42" x2="8" y2="22" stroke="#0284C7" strokeWidth=".8" opacity=".6"/>
          <line x1="8" y1="42" x2="-8" y2="22" stroke="#0284C7" strokeWidth=".8" opacity=".6"/>
          ...
          <circle cx="0" cy="-40" r="5" fill="none" stroke="#ef4444" strokeWidth=".8" opacity=".5" style={{animation:'node-blink 1.2s ease-in-out infinite'}}/>
        </g>
        <circle className="t2-pulse" cx="360" cy="142" fill="none" stroke="#0284C7" strokeWidth=".8"/>
        <circle className="t2-pulse2" cx="360" cy="142" fill="none" stroke="#0284C7" strokeWidth=".8"/>
        <path className="arc3" d="M 326 122 A 40 40 0 0 1 394 122" fill="none" stroke="#0284C7" strokeWidth="1.2" strokeLinecap="round"/>
        <path className="arc4" d="M 308 106 A 58 58 0 0 1 412 106" fill="none" stroke="#0284C7" strokeWidth=".9" strokeLinecap="round"/>
        ...
        <circle className="t3-pulse" cx="230" cy="275" fill="none" stroke="#38bdf8" strokeWidth=".6"/>
        <circle className="t3-pulse2" cx="230" cy="275" fill="none" stroke="#38bdf8" strokeWidth=".6"/>
        <path className="arc5" d="M 184 258 A 50 50 0 0 1 276 258" fill="none" stroke="#38bdf8" strokeWidth="1" strokeLinecap="round"/>
        <path className="arc6" d="M 164 240 A 70 70 0 0 1 296 240" fill="none" stroke="#38bdf8" strokeWidth=".7" strokeLinecap="round"/>
        <line className="line1" x1="108" y1="255" x2="222" y2="278" stroke="#0284C7" strokeWidth=".8" strokeDasharray="6 4"/>
        <line className="line2" x1="238" y1="276" x2="342" y2="148" stroke="#0284C7" strokeWidth=".8" strokeDasharray="6 4"/>
        <line className="line3" x1="108" y1="250" x2="334" y2="148" stroke="#38bdf8" strokeWidth=".6" strokeDasharray="4 6"/>
        ...
        <line className="line4" x1="100" y1="270" x2="155" y2="415" stroke="#38bdf8" strokeWidth=".6" strokeDasharray="4 5"/>
        <line className="line1" x1="222" y1="290" x2="305" y2="408" stroke="#38bdf8" strokeWidth=".6" strokeDasharray="4 5"/>
        <line className="line2" x1="350" y1="180" x2="405" y2="350" stroke="#0284C7" strokeWidth=".6" strokeDasharray="4 5"/>
        {[0,60,120,180,240,300,360,420,480].map(x=>(
          <line key={`gx${x}`} x1={x} y1="0" x2={x} y2="520" stroke="#38bdf8" strokeWidth=".3" opacity=".15"/>
        ))}
        {[0,60,120,180,240,300,360,420,480,520].map(y=>(
          <line key={`gy${y}`} x1="0" y1={y} x2="480" y2={y} stroke="#38bdf8" strokeWidth=".3" opacity=".15"/>
        ))}
      </svg>
    </div>
  )
          ...
          <div style={{ position:'relative', zIndex:1 }}>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[11px] leading-tight" style={{ color:'rgba(255,255,255,0.4)' }}>Panel de supervisión</div>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col justify-center p-8 md:p-10 w-full md:w-[340px] flex-shrink-0"
          ...
          <form onSubmit={submit} style={{ display:'flex', flexDirection:'column', gap:14 }}>
            <div style={{ display:'flex', flexDirection:'column', gap:5 }}>
              <label style={{ fontSize:11, fontWeight:600, color:'#7a8fa0', textTransform:'uppercase', letterSpacing:'.05em' }}>
                Correo electrónico
              </label>
              <input type="email" value={email} onChange={e=>setEmail(e.target.value)}
                autoFocus autoComplete="email"
                style={{ height:38, padding:'0 12px', borderRadius:8, border:'1px solid #e2e8f0',
                  fontSize:13, color:'#0d2137', background:'#f8fafc', outline:'none',
            ...
            <button type="submit" disabled={loading}
              style={{ height:40, borderRadius:8, border:'none',
